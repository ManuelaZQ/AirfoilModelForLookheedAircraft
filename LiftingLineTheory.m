...
% Inputs:
%         V       = Cruise speed (m/s)
%         xCG     = Center of gravity position respect to aircraft datum
%         xAC     = Aerodynamic center position respect to aircraft datum
...
%
% thanks for help to: Joseph Derlaga

function [CL, CDi, Cm, ai, w, e] = ...
    LiftingLineTheory(V, xCG, xAC, a0, AR, lambda, alpha0l, alpha, c, numlocs)
